...
The DCF77 module can be attached to adjust the time to the second with German longwave time signal received by the module
 ...
 Changes.: Character_Clock_WS2812_Nov2020  Sep2020 is for 113 LEDs this version is default for 96 LEDs
 */
// ===============================================================================================================================
...
const byte MenuItems = 17;              // sentences, rows, in menu
const char menu[MenuItems][MAXTEXT] PROGMEM =  {
 "Rick Degens Woordklok",
 "Voer in:",
 ...
 "X       Demo mode",
 "Z       Zelftest",
 "Ed Nieuwenhuys  Character_Clock_WS2812 Sep 2020" };
