...
#define HET     Serial.print(F("Het "));    ColourLeds(0,2,LetterColor);   
#define IS      Serial.print(F("is "));     ColourLeds(3,4,LetterColor); Is = true;
#define WAS     Serial.print(F("was "));    ColourLeds(5,8,LetterColor); Is = false;

#define MVIJF   Serial.print(F("vijf "));   ColourLeds(14,18,LetterColor); 
#define MTIEN   Serial.print(F("tien "));   ColourLeds(9,13,LetterColor);

#define KWART   Serial.print(F("kwart "));  ColourLeds(19,24, LetterColor);
#define VOOR    Serial.print(F("voor "));   ColourLeds(25,29, LetterColor); 

#define OVER    Serial.print(F("over "));   ColourLeds(38,42,LetterColor);
#define PRECIES Serial.print(F("precies "));ColourLeds(30,37,LetterColor);

#define HALF    Serial.print(F("half "));   ColourLeds(43,47, LetterColor);
#define ELF     Serial.print(F("elf "));    ColourLeds(48,51, LetterColor);

#define VIJF    Serial.print(F("vijf "));   ColourLeds(57,61,LetterColor);
#define TWEE    Serial.print(F("twee "));   ColourLeds(52,56,LetterColor);

#define EEN     Serial.print(F("een "));    ColourLeds(62,65, LetterColor);
#define VIER    Serial.print(F("vier "));   ColourLeds(66,70, LetterColor);

#define TIEN    Serial.print(F("tien "));   ColourLeds(78,82,LetterColor);
#define TWAALF  Serial.print(F("twaalf ")); ColourLeds(71,77,LetterColor);

#define DRIE    Serial.print(F("drie "));   ColourLeds(83,87, LetterColor);
#define NEGEN   Serial.print(F("negen "));  ColourLeds(88,93, LetterColor);

#define ACHT    Serial.print(F("acht "));   ColourLeds(98,102,LetterColor);
#define ZES     Serial.print(F("zes "));    ColourLeds(94,97,LetterColor); 
  
#define ZEVEN   Serial.print(F("zeven "));  ColourLeds(103,108, LetterColor);
#define UUR     Serial.print(F("uur "));    ColourLeds(109,112, LetterColor);
...
DS3231M_Class RTC;  ///< Create an instance of the DS3231M class
